                        ...
                        <div class="col-12 col-lg-5">
                            <div class="card-body p-lg-5">
                                ...
                                <form method="POST" action="{{ route('login.tfa.validate') }}">
                                    ...
                                    <input hidden id="i-email" type="text" dir="ltr" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}">

                                    <input hidden id="i-password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ old('password') }}">
